...
const filePath = '/home/user/components/contact-section.tsx'
let content = readFileSync(filePath, 'utf8')

console.log('File read, length:', content.length)

// Replace email div -> anchor
...
console.log('Email replaced:', content !== before || content.includes('mailto:'))
